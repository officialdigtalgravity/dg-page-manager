...
use Bamalik\RegionLocale\RegionLocale;
...
class Page extends TemplateResource
{
    ...
    public function fields(Request $request)
    {
        ...
        $fields = [
            ...
            RegionLocale::make('Region')->rules('required'),
        ...
        if (NovaPageManager::hasNovaLang()) {
          //  $fields[] = \OptimistDigital\NovaLang\NovaLangField::make('Locale', 'locale', 'locale_parent_id')->onlyOnForms();
            ...
            $fields[] = LocaleField::make('Locale', 'locale', 'locale_parent_id')->onlyOnForms();
        }
        ...
        $fields[]=  new Panel('SEO', [
            SeoMeta::make('SEO', 'seo_meta'),
            Code::make('Tags', 'seo_tags')->hideFromDetail()
        ]);
